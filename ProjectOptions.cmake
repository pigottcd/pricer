...
macro(pricer_setup_options)
  ...
  pricer_check_libfuzzer_support(LIBFUZZER_SUPPORTED)
  if(LIBFUZZER_SUPPORTED AND (pricer_ENABLE_SANITIZER_ADDRESS OR pricer_ENABLE_SANITIZER_THREAD OR pricer_ENABLE_SANITIZER_UNDEFINED))
    set(DEFAULT_FUZZER ON)
  else()
    set(DEFAULT_FUZZER OFF)
  endif()

  option(pricer_BUILD_FUZZ_TESTS "Enable fuzz testing executable" ${DEFAULT_FUZZER})
