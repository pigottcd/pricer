...
// configuration step. It creates a namespace called `pricer`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", pricer::cmake::project_name, pricer::cmake::project_version) };
